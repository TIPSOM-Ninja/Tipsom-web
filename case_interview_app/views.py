...
def save_exploitation(request):
    ...
    if request.method == "POST":
        ...
        exploitation.subject_to_exploitation = request.POST['subject_to_exploitation'] if request.POST.get('subject_to_exploitation') is not None else None
        exploitation.intent_to_exploit = request.POST['intent_to_exploit'] if request.POST.get('intent_to_exploit') is not None else None
        exploitation.exploitation_length = request.POST['exploitation_length'] if request.POST.get('exploitation_length') is not None else None
        exploitation.exploitation_age_id = request.POST['exploitation_age_id'] if request.POST.get('exploitation_age_id') is not None else None
        exploitation.pay_debt = request.POST['pay_debt'] if request.POST.get('pay_debt') is not None else None
        exploitation.debt_amount = request.POST['debt_amount'] if request.POST.get('debt_amount') is not None else None
        exploitation.freed_method_id = request.POST['freed_method_id'] if request.POST.get('freed_method_id') is not None else None
        exploitation.event_description = request.POST['event_description'] if request.POST.get('event_description') is not None else None
        exploitation.e_prostitution = request.POST['e_prostitution'] if request.POST.get('e_prostitution') is not None else None
        exploitation.e_other_sexual = request.POST['e_other_sexual'] if request.POST.get('e_other_sexual') is not None else None
        exploitation.e_other_sexual_online = request.POST['e_other_sexual_online'] if request.POST.get('e_other_sexual_online') is not None else None
        exploitation.e_online_porno = request.POST['e_online_porno'] if request.POST.get('e_online_porno') is not None else None
        exploitation.e_criminal_activity = request.POST['e_criminal_activity'] if request.POST.get('e_criminal_activity') is not None else None
        exploitation.e_forced_labour = request.POST['e_forced_labour'] if request.POST.get('e_forced_labour') is not None else None
        exploitation.e_forced_marriage = request.POST['e_forced_marriage'] if request.POST.get('e_forced_marriage') is not None else None
        exploitation.e_victim_knew_spouse = request.POST['e_victim_knew_spouse'] if request.POST.get('e_victim_knew_spouse') is not None else None
        exploitation.e_spouse_nationality_id = request.POST['e_spouse_nationality_id'] if request.POST.get('e_spouse_nationality_id') is not None else None
        exploitation.e_bprice_paid_id = request.POST['e_bprice_paid_id'] if request.POST.get('e_bprice_paid_id') is not None else None
        exploitation.e_bprice_amount_kind = request.POST['e_bprice_amount_kind'] if request.POST.get('e_bprice_amount_kind') is not None else None
        exploitation.e_child_marriage = request.POST['e_child_marriage'] if request.POST.get('e_child_marriage') is not None else None
        exploitation.e_victim_pregnancy = request.POST['e_victim_pregnancy'] if request.POST.get('e_victim_pregnancy') is not None else None
        exploitation.e_children_from_marriage = request.POST['e_children_from_marriage'] if request.POST.get('e_children_from_marriage') is not None else None
        exploitation.e_maternal_health_issues = request.POST['e_maternal_health_issues'] if request.POST.get('e_maternal_health_issues') is not None else None
        exploitation.e_m_health_issues_description = request.POST['e_m_health_issues_description'] if request.POST.get('e_m_health_issues_description') is not None else None
        exploitation.e_marriage_violence_id = request.POST['e_marriage_violence_id'] if request.POST.get('e_marriage_violence_id') is not None else None
        exploitation.e_forced_military_type_id = request.POST['e_forced_military_type_id'] if request.POST.get('e_forced_military_type_id') is not None else None
        exploitation.e_armed_group_name = request.POST['e_armed_group_name'] if request.POST.get('e_armed_group_name') is not None else None
        exploitation.e_child_soldier = request.POST['e_child_soldier'] if request.POST.get('e_child_soldier') is not None else None
        exploitation.e_child_soldier_age = request.POST['e_child_soldier_age'] if request.POST.get('e_child_soldier_age') is not None else None
        exploitation.e_organ_removed = request.POST['e_organ_removed'] if request.POST.get('e_organ_removed') is not None else None
        exploitation.e_operation_location_id = request.POST['e_operation_location_id'] if request.POST.get('e_operation_location_id') is not None else None
        exploitation.e_operation_country_id = request.POST['e_operation_country_id'] if request.POST.get('e_operation_country_id') is not None else None
        exploitation.e_organ_sale_price = request.POST['e_organ_sale_price'] if request.POST.get('e_organ_sale_price') is not None else None
        exploitation.e_organ_paid_to_id = request.POST['e_organ_paid_to_id'] if request.POST.get('e_organ_paid_to_id') is not None else None
        exploitation.e_remarks = request.POST['e_remarks'] if request.POST.get('e_remarks') is not None else None
        exploitation.e_recruitment_type_id = request.POST['e_recruitment_type_id'] if request.POST.get('e_recruitment_type_id') is not None else None
        exploitation.e_recruiter_relationship_id = request.POST['e_recruiter_relationship_id'] if request.POST.get('e_recruiter_relationship_id') is not None else None
        exploitation.save()
